namespace GrafcetStudioAIApplyValidation {
  ...
  export function runApplyValidation(): ApplyValidationResult {
    ...
    const appliedFlowState = (flowProject.diagrams[0] as unknown as { state?: GrafcetStudioProject.DiagramState }).state || { steps: [], transitions: [], connections: [] };
    ...
    const flowBackfillProposal = makeCreateFlowProposal('ai-prop-flow-backfill', {
      ...
      steps: [
        ...
        { id: 'step-2', label: 'Step 2', actions: [{ expression: 'cy14.CoilB = 1' } as unknown as GrafcetStudioProject.StepAction] }
      ],
    ...
    const flowBackfillState = (flowBackfillProject.diagrams[0] as unknown as { state?: GrafcetStudioProject.DiagramState }).state || { steps: [], transitions: [], connections: [] };
