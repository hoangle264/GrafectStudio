namespace GrafcetStudioAISanitizerValidation {
  export interface SanitizerValidationResult {
    ok: boolean;
    errors: string[];
    sanitized: GrafcetStudioAISanitizer.SanitizedAiContext;
  }
  ...
  export function runSanitizerValidation(): SanitizerValidationResult {
    const errors: string[] = [];
    const rawVariable = {
      id: 'var-1',
      label: 'MotorStart',
