...
public static class AiPromptBuilder
{
    public static string BuildSystemPrompt(string intent)
    {
        var intentRequirements = intent switch
        {
            ...
            "create-flow" => "Return data.flow only. Keep the flow minimal and structurally complete. steps, transitions, and connections must use proposal node ids only, and every connection.from/to must reference an id emitted in the same proposal.",
