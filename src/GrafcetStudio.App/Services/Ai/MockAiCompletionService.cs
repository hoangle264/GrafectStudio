...
public class MockAiCompletionService : IAiCompletionService
{
    ...
    private static string BuildProposalFixture(string intent, string requestId)
        => intent switch
        {
            ...
            {
                source = new { label = "Cylinder" },
                variables = new[]
                {
                    new { label = "Cyl_A", format = "Cylinder", kind = "struct", comment = "Clone A", source = "manual" },
                    new { label = "Cyl_B", format = "Cylinder", kind = "struct", comment = "Clone B", source = "manual" },
                    new { label = "Cyl_C", format = "Cylinder", kind = "struct", comment = "Clone C", source = "manual" }
                }
            }, "Mock proposal clones Cylinder struct into 3 instances."),
