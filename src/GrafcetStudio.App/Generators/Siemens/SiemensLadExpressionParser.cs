...
public static class SiemensLadExpressionParser
{
    ...
    private const string TagDescription = "letter, digit, '_', '.', '[' or ']'";

    private static readonly Parser<string> TagToken = Sprache.Parse.Char(c => char.IsLetterOrDigit(c) || c is '_' or '.' or '[' or ']', TagDescription)
        .AtLeastOnce()
        .Text()
        .Token();
